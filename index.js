...
function buildRewritePrompt(before, target, after, phrases) {
    ...
    return [
        ...
        "",
        "Examples (illustration only):",
        '  Repeated "팔을 깨물었다": OO은 팔을 깨물었다 → OO은 입술을 짓씹었다  (same anxious gesture, expressed differently)',
        '  Repeated "낡은 가방": 낡은 가방을 만지작거렸다 → 낡은 물건을 만지작거렸다  (a natural synonym swap is enough)',
